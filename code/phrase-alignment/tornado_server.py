...
if __name__ == "__main__":
    ...
    # Make sure to truncate (I believe it must be 128 tokens...)
    # sent1 = """In particular , modern imaging and machine learning methods rely strongly on maximum-a-posteriori estimation"""
    # sent2 = """In particular , modern imaging and machine learning methods rely strongly on maximum-a-posteriori ( MAP ) estimation"""
    # sent1 = """With Canadian collaborators, Lloyd went on to conduct laboratory simulations of his model."""
    # sent2 = """Lloyd performed successful laboratory experiments of his model."""
    # ^^ ['3-0', '4-1', '5-1', '6-1', '7-1', '8-3', '9-4', '10-5', '11-6', '12-7']
    # sent1 = """The obtained results are summarized in section [REF] ."""
    # sent2 = """The results of the investigation are summarized in section [REF] ."""
    # ^^ 0-0 2-1 3-5 4-6 5-7 6-8 7-9 8-10 
	# ['0-0', '2-1', '3-5', '4-6', '5-7', '6-8', '7-9', '8-10']
    # sent1 = """The obtained results are summarized in section 5."""
    # sent2 = """The results of the investigation are summarized in section 5."""
    # ['0-0', '2-1', '3-5', '4-6', '5-7', '6-8', '7-9']

    sent1 = """Google subsequently made the comic available on Google Books and their site and mentioned it on its official blog along with an explanation for the early release."""
    sent2 = """Google made the comic available on google books and their site and mentioned it on its official blog."""

    print('Starting evaluation...')
    out = single_inference(sent1, sent2)
    out_tuples = [(x[0], x[1]) for x in sorted([[int(i) for i in x.split('-')] for x in out], key = lambda x: x[0])]
    out = [f'{x[0]}-{x[1]}' for x in out_tuples]
    
    print(f'{sent1}\n{sent2}')
    print(out)

    for tup in out_tuples:
        print(sent1.split(" ")[tup[0]] + " -> " + sent2.split(" ")[tup[1]])

    # find a way to print the deletions & additions.
